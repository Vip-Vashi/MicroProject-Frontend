        ...
        axios.put('http://localhost:8000/products/bid', formData)
            .then(() => {
                ...
                const bids={
                    ...
                    bidder:sessionStorage.getItem('userid'),
                    biddingprice:auctionDetails.currentBiddingPrice


                }
                console.log("*************************")
                console.log(bids);
                axios.post('http://localhost:8000/biddings',bids)
                ...
                {filteredProducts.map(product => (
                    <div key={product.productId} className="bg-white border border-gray-200 rounded-lg p-2 rounded-2xl overflow-hidden transition-transform transform hover:scale-105 hover:shadow-2xl">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-500 mb-4">Your Last Bid: {product.endTimeDate}</p>
                            <button
