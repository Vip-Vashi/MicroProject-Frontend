...
function VideoCarousel() {
  ...
  return (
    <div id="video-carousel" className="relative w-full h-[95vh] mt-20" data-carousel="slide">
      ...
      <div className="hidden duration-1000 ease-in-out" data-carousel-item>
        ...
        <div className="hidden duration-1000 ease-in-out" data-carousel-item>
          <video 
            ...
            src="https://cdnl.iconscout.com/lottie/premium/preview-watermark/people-bidding-for-auction-animation-download-in-lottie-json-gif-static-svg-file-formats--asking-price-voting-at-agent-pack-animations-6879404.mp4"
            className="absolute block w-full h-full object-cover"
            alt="Slide 2"
            // controls
          />
